...
<body style="direction: '<spring:message code='dir' text='ltr' />'" dir="<spring:message code='dir' text='ltr' />"
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div id="loader">&nbsp;</div>
            <!-- START filter -->
            <c:url var="actionUrl" value="/api/contacts/search/byExample"/>
                ...
                <table class="filter" summary="<spring:message code='contacts.filter' text='Filter' />">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th><label><spring:message code='contact.dob' text='Birth Date' /></label></th>
                            <th><label><spring:message code='contact.married' text='Is Married?' /></label></th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" id="dateOfBirth" placeholder="<spring:message code='contact.dob.placeholder' text='12/31/1990' />" pattern="[0-9]{2}/[0-9]{2}/[0-9]{4}" oninvalid="this.setCustomValidity('${dobErrMsg}')" oninput="setCustomValidity('')" /></td>
            ...
            <div class="table">
                ...
                <div class="th">
                    ...
                    <div>
                        ...
                        <input class="th" value="<spring:message code='contact.dob' text='Birth Date' />" readonly="readonly" />
                    </div>
                    <div>
